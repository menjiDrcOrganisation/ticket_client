...
<html lang="fr">
    <head>
        ...
        <title>
            {{ $evenement["nom"] ?? "Événement" }} | Billetterie MenjiDRC
        </title>
    ...
    <body class="bg-gray-900 text-white relative overflow-x-hidden">
        ...
        >
            <div
                class="text-center p-6 bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full fade-in"
            >
                <i
                ...
                <a
                    href="/"
                    class="inline-block bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-full transition-all duration-300 transform hover:scale-105"
                >
                    Retour à l'accueil
                </a>
            </div>
        ...
        <!-- Navigation -->
        <nav
            class="fixed top-0 left-0 w-full z-50 bg-gray-900/80 backdrop-blur-md border-b border-gray-800"
        >
            <div
            ...
            >
                <div class="flex items-center space-x-2">
                    ...
                    <span
                        class="text-xl font-bold truncate max-w-[150px] md:max-w-none"
                        >{{ $evenement["nom"] }}</span
                    >
                </div>
            ...
            <div
                id="mobile-menu"
                class="md:hidden bg-gray-900 border-t border-gray-800 hidden"
            >
                <div
        ...
        <!-- Section Hero -->
        <header
            class="relative min-h-screen hero-bg flex items-center justify-center pt-16 px-4"
        ...
        >
            ...
            <div
                class="relative z-10 text-center w-full max-w-6xl mx-auto space-y-8"
            >
                <div
                    class="inline-block bg-red-600/20 border border-red-500/30 rounded-full px-4 py-2 mb-4"
                >
                ...
                <h1
                    class="title-responsive font-extrabold uppercase tracking-tight"
                >
                    <span
                        class="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent text-typing"
                    >
                        {{ $evenement["nom"] }}
                    </span>
                </h1>
                ...
                <div
                    class="text-responsive font-medium space-y-3 max-w-2xl mx-auto"
                >
                    <p
                        class="flex items-center justify-center gap-2 text-float flex-wrap"
                    >
                        <i
                            data-lucide="map-pin"
                    ...
                    <p
                        class="flex items-center justify-center gap-2 flex-wrap justify-center"
                    >
                        <span
                            class="font-bold text-yellow-400 flex items-center gap-1 text-bounce"
                        >
                        ...
                        <span class="text-gray-300 mx-2 hidden md:inline"
                            >→</span
                        >
                        <span
                            class="text-gray-300 flex items-center gap-1 text-bounce"
                        >
                ...
                <div
                    class="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 max-w-3xl mx-auto border border-white/20"
                >
                    <p
                        class="text-lg md:text-2xl text-center italic text-gray-200 text-gradient-animate"
                    >
            ...
            <div
                class="absolute bottom-10 left-1/2 transform -translate-x-1/2 text-bounce"
            >
        ...
        <section
            id="about"
            class="py-16 md:py-20 bg-gray-800 section-padding relative overflow-hidden"
        >
            <div
            ...
            <div class="max-w-6xl mx-auto">
                <h2
                    class="section-title text-3xl md:text-4xl font-bold mb-6 text-center"
                >
                    À propos de l'événement
                </h2>
                <div class="bg-gray-900/50 rounded-2xl p-6 md:p-12 shadow-2xl">
                    <p
                        class="text-lg leading-relaxed text-gray-300 text-center md:text-left"
                    >
                        {{
        ...
        <section
            id="tickets"
            class="py-16 md:py-20 bg-gray-900 section-padding"
        >
            <div class="max-w-6xl mx-auto">
                <h2
                    class="section-title text-3xl md:text-4xl font-bold mb-8 md:mb-12 text-center"
                >
                    Billets disponibles
                </h2>

                <div
                    class="ticket-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8"
                >
                    @foreach($evenement['type_billets'] as $index => $billet)
                    <div
                        class="ticket-card bg-white shadow-2xl hover-lift rounded-2xl p-6 md:p-8 flex flex-col items-center text-center"
                    >
                        <div class="bg-red-100 p-4 rounded-2xl mb-6">
                            <i
                                data-lucide="ticket"
                                class="w-10 h-10 md:w-12 md:h-12 text-red-600"
                            ></i>
                        </div>
                        <h3
                            class="text-xl md:text-2xl font-semibold mb-3 text-gray-800"
                        >
                        ...
                        <p
                            class="text-3xl md:text-4xl font-bold text-red-600 mb-2"
                        >
                            {{
                                number_format(
                                    $billet["pivot"]["prix_unitaire"] ?? 0,
                                    0,
                                    ",",
                                    " "
                                )
                            }} {{ $billet["pivot"]["devise"] ?? "FC" }}
                        </p>
                        <p class="text-sm text-gray-500 mb-6">Disponible</p>
                        <button
                            class="w-full buy-ticket-btn bg-red-600 hover:bg-red-700 text-white py-3 rounded-full font-bold transition-all duration-300 transform hover:scale-105"
        ...
        <section
            id="location"
            class="py-16 md:py-20 bg-gray-800 section-padding"
        >
            <div class="max-w-6xl mx-auto">
                <h2
                    class="section-title text-3xl md:text-4xl font-bold mb-8 md:mb-12 text-center"
        ...
        <div id="payment-modal" class="modal">
            <div class="modal-content payment-modal">
                ...
                <p
                    class="text-gray-400 mb-4 md:mb-6 text-sm md:text-base"
                    id="modal-subtitle"
                >
                ...
                <form id="payment-form" class="space-y-4">
                    ...
                    <input
                        type="hidden"
                        id="selected-ticket-type"
                        name="type_billet"
                    />

                    <div
                        class="form-grid grid grid-cols-1 md:grid-cols-2 gap-4"
                    >
                        <div>
                            <label
                                for="fullname"
                    ...
                    <div class="pt-4 border-t border-gray-700">
                        ...
                        <button
                            type="submit"
                            class="w-full bg-red-600 hover:bg-red-700 text-white py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2"
                        >
            ...
            <div class="modal-content">
                ...
                <div class="text-center">
                    <button
                        ...
                        class="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-semibold mr-2 w-full md:w-auto mb-2 md:mb-0"
                        data-name_user=""
                        data-name_event=""
                        data-name_location=""
                        data_type=""
                    ...
                    <button
                        ...
                        class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-semibold w-full md:w-auto"
                    >
                        Fermer
                    </button>
                </div>
        ...
        <footer
            id="contact"
            class="bg-gray-900 py-12 px-6 border-t border-gray-800"
        >
            <div class="max-w-6xl mx-auto">
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-center space-x-2 mb-4">
                            ...
                            <span class="text-xl font-bold"
                                >Menji<span class="text-red-500"
                                    >DRC</span
                                ></span
                            >
                        </div>
                        <p class="text-gray-400 mb-4">
                            Votre plateforme de billetterie de confiance pour
                            les meilleurs événements en République Démocratique
                            du Congo.
                        </p>
                        ...
                        <div class="flex space-x-4">
                            <a
                                href="#"
                                class="bg-gray-800 p-3 rounded-full text-gray-300 hover:bg-red-600 hover:text-white transition-all"
                            >
                ...
                <div
                    class="pt-8 border-t border-gray-800 text-center text-gray-500"
                >
                    ...
                    document.getElementById('payment-form').addEventListener('submit', async function(e) {
                        ...
                        try {
                            ...
                            if (result.status === true) {
                                ...
                                const downland = document.getElementById("downland");

                                    downland.addEventListener('click', function(e) {
                                    e.preventDefault();

                                    // Empêche le comportement par défaut

                                    this.setAttribute("data-name_user",result.billet.name_user)
                                    this.setAttribute("data-name_event",result.billet.name_event)
                                    this.setAttribute("data-name_location",result.billet.location)
                                    this.setAttribute("data-type",result.billet.type)
                                    this.setAttribute("data-quantity",result.billet.quantity)
                                    this.setAttribute("data-price",result.billet.price)
                                    this.setAttribute("data-qrcode",result.billet.code_billet)
                                    this.setAttribute("data-date",result.billet.date)
                                    this.setAttribute("data-heure",result.billet.heure)
